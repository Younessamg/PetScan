...
from .views import index, animals,mites, cat_conjunct, Cats,Dogs,Kennel,disclaimer,learnmore,cateyes,CatConjunctForm,bloating, login_view, register_view, admin_dashboard, account
...
urlpatterns = [
    ...
    path('Cats/mites/', mites, name='mites'),
